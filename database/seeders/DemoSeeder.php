...
class DemoSeeder extends Seeder
{
    ...
    private function seedProductos(): void
    {
        ...
        $productos = [
            // Insumos / Materia Prima — para menús (precios Bolivia 2026)
            [
            ...
            // Más productos de venta directa
            [
                'nombre'         => 'Salteña',
                'codigo'         => 'ALI-005',
            ...
            [
                'nombre'         => 'Api (mate de maíz morado)',
                'codigo'         => 'BEB-007',
                'categoria_id'   => $cats['Bebidas Calientes'],
                'precio_venta'   => 7.00,
                'costo_unitario' => 3.00,
        ...
        $this->command->line('  ✓ Productos creados (14 productos: 7 insumos + 7 venta directa)');
    }
    ...
    private function seedMenus(): void
    {
        ...
        $menus = [
            ...
            [
                ...
                'precio_venta'      => 12.00,
                'disponible_desde'  => '07:00',
                'disponible_hasta'  => '21:00',
                'activo'            => true,
                'ingredientes' => [
                    ['producto' => 'Café en grano',  'cantidad' => 0.020, 'unidad' => 'kg'],
                    ['producto' => 'Leche entera',   'cantidad' => 0.120, 'unidad' => 'lt'],
                    ['producto' => 'Canela entera',   'cantidad' => 0.002, 'unidad' => 'kg'],
                ],
            ],
            [
                'nombre'            => 'Mocachino',
                ...
                'ingredientes' => [
                    ['producto' => 'Café en grano',      'cantidad' => 0.018, 'unidad' => 'kg'],
                    ['producto' => 'Chocolate en polvo', 'cantidad' => 0.010, 'unidad' => 'kg'],
                    ['producto' => 'Leche entera',       'cantidad' => 0.120, 'unidad' => 'lt'],
                ],
            ],
            [
                'nombre'            => 'Api con pastel',
                'descripcion'       => 'Api tradicional de maíz morado con pastel de queso',
                'categoria_id'      => $cats['Bebidas Calientes'],
                'precio_venta'      => 14.00,
                'disponible_desde'  => '06:00',
                'disponible_hasta'  => '12:00',
                'activo'            => true,
                'ingredientes' => [
                    ['producto' => 'Harina de trigo', 'cantidad' => 0.050, 'unidad' => 'kg'],
                    ['producto' => 'Azúcar',           'cantidad' => 0.020, 'unidad' => 'kg'],
                    ['producto' => 'Canela entera',    'cantidad' => 0.003, 'unidad' => 'kg'],
                ],
            ],
            [
                'nombre'            => 'Salteña de carne',
                'descripcion'       => 'Salteña jugosa de carne, horneada al momento',
                'categoria_id'      => $cats['Alimentos'],
                'precio_venta'      => 10.00,
                'disponible_desde'  => '07:00',
                'disponible_hasta'  => '13:00',
                'activo'            => true,
                'ingredientes' => [
                    ['producto' => 'Harina de trigo', 'cantidad' => 0.040, 'unidad' => 'kg'],
                ],
            ],
        ];
        ...
        $this->command->line('  ✓ Menús creados con ingredientes (9 menús: 5 originales + 4 nuevos)');
    }
    ...
    private function seedInventario(): void
    {
        ...
        $lotes = [
            ...
            [
                ...
                'fecha_vencimiento' => Carbon::now()->addDays(3)->toDateString(),
            ...
            [
                ...
                'fecha_vencimiento' => Carbon::now()->addDays(2)->toDateString(),
            ...
            // Canela entera
            [
                'producto_id'       => $prods['Canela entera'],
                'cantidad_inicial'  => 3,
                'cantidad_disponible'=> 3,
                'costo_unitario'    => 30.00,
                'fecha_entrada'     => Carbon::now()->subDays(15)->toDateString(),
                'fecha_vencimiento' => Carbon::now()->addMonths(6)->toDateString(),
                'numero_lote'       => 'CANELA-001',
                'estado'            => 'disponible',
            ],
            // Té de coca en hojas
            [
                'producto_id'       => $prods['Té de coca en hojas'],
                'cantidad_inicial'  => 8,
                'cantidad_disponible'=> 8,
                'costo_unitario'    => 20.00,
                'fecha_entrada'     => Carbon::now()->subDays(20)->toDateString(),
                'fecha_vencimiento' => Carbon::now()->addMonths(8)->toDateString(),
                'numero_lote'       => 'COCA-001',
                'estado'            => 'disponible',
            ],
            // Esencia de vainilla
            [
                'producto_id'       => $prods['Esencia de vainilla'],
                'cantidad_inicial'  => 2,
                'cantidad_disponible'=> 2,
                'costo_unitario'    => 50.00,
                'fecha_entrada'     => Carbon::now()->subDays(10)->toDateString(),
                'fecha_vencimiento' => Carbon::now()->addMonths(12)->toDateString(),
                'numero_lote'       => 'VAINILLA-001',
                'estado'            => 'disponible',
            ],
        ];
    ...
    private function seedTurnoYVentas(): void
    {
        ...
        $ventas = [
            [
                ...
                'total'       => 23.00,
                'costo_total' => 3.60,
                'items'       => [['menu' => 'Combo mañana', 'cantidad' => 1, 'precio' => 15.00], ['menu' => 'Café americano', 'cantidad' => 1, 'precio' => 8.00]],
            ],
            [
                'metodo_pago' => 'efectivo',
    ...
    private function seedCompras(): void
    {
        ...
        $compras = [
            [
                ...
                'items'        => [
                    ['producto' => 'Café en grano', 'cantidad' => 10, 'costo' => 65.00],
                ],
            ],
            [
                ...
                'items'        => [
                    ['producto' => 'Leche entera', 'cantidad' => 30, 'costo' => 8.00],
                ],
            ],
        ];
