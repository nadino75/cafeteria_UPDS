...
const NAV_CONFIG = {
  Administrador: [
    ...
    { grupo: 'Usuarios',   label: 'Usuarios',      ruta: '/dashboard/usuarios',     icono: I.users },
  ...
  Cajero: [
    ...
    { grupo: 'Mi turno', label: 'Ventas',   ruta: '/dashboard/ventas',   icono: I.cart },
    {                    label: 'Turnos',   ruta: '/dashboard/turnos',   icono: I.clock },
    {                    label: 'Clientes', ruta: '/dashboard/clientes', icono: I.users },
    { grupo: 'Consulta', label: 'Menús',   ruta: '/dashboard/menus',    icono: I.menu },
  ],
  Almacenista: [
    { label: 'Dashboard', ruta: '/dashboard/almacenista', icono: I.grid },
    { grupo: 'Inventario', label: 'Inventario',  ruta: '/dashboard/inventario',  icono: I.box },
    {                      label: 'Categorías',  ruta: '/dashboard/categorias',  icono: I.folder },
    {                      label: 'Productos',   ruta: '/dashboard/productos',   icono: I.tag },
    { grupo: 'Compras',    label: 'Compras',     ruta: '/dashboard/compras',     icono: I.bag },
    {                      label: 'Proveedores', ruta: '/dashboard/proveedores', icono: I.truck },
  ],
  Contador: [
